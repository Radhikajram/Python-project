...
def show_mandebrot_image_mn(input_data):

    #main.show_mandebrot_image_main(input_data)
    ...
    #res = creteMandelbrotImage(input_data.Minimumreal,input_data.Minimumimag,input_data.Maximumreal,
    #                    input_data.Maximumimag,input_data.MaxInteration,input_data.xaxis,input_data.yaxis)
